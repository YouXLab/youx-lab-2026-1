#================================================|=======================================|=====================================================================
#================================================|===DESAFIO=FINAL=YOUX=2026/05=FASE=01==|=====================================================================
#================================================|=======================================|=====================================================================
funcionario = [
...
#=====================
print("\033[033m=" * 60)
print("   ==================SISTEMA SALARIAL===================")
print("=" * 60)
#==========================SISTEMA DE NOVO SALARIO==============================#
...
#========================== Nova chave no dicionário ============================
    funcionario["novo_salario"] = novo_salario
#==========================     Exibição    =====================================
    print(f"Funcionário {funcionario['Nome']}: "
          f"salário antigo = {funcionario['Salario']}, "
          f"salário novo = {funcionario['novo_salario']:.2f}")

#DIFICULDADE MEDIANA ME PERDI UM POUCO MAIS ME ACHEI ESPERROOO ESTAR CERTOO👍 