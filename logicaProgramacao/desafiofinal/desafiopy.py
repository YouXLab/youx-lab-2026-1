...
for p in funcionarios: #aqui percorre a lista
    if p ["anos_trabalhados"] > 5 : #aqui gente f
        novo_Salario = p["Salario"] * 120/100 # aqui a gente faz a conta para saber um novo salario
    else:
        novo_Salario = p["Salario"] * 110/100 # aqui tambem a gente faz a soma

    p['novo_salario'] = novo_Salario
    print(f"funcionario{p['Nome']}: salario antigo = {p['Salario']}: salario novo= {p['novo_salario']}")# aqui gente faz o print para mostrar a mensagens



# eu senti dificuldade em acessar o disionário e como mexer nele
# tamabem na logica, na hora da interpretção
